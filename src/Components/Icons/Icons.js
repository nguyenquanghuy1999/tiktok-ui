...
export const MessageIcon = forwardRef(({ width = "2.6rem", height = "2.6rem", className }, ref) => (
    <svg
        ref={ref}
        className={className}
        width={width}
...
export const InboxIcon = forwardRef(({ width = "3.2rem", height = "3.2rem", className }, ref) => (
    <svg
        ref={ref}
        className={className}
        width={width}
